...
public class ActivityNavigator implements Navigator {
    ...
    @Override
    public void startActivityForResult(@NonNull Class<? extends Activity> activityClass,
                                       @NonNull PlainConsumer<Intent> setArgsAction, int requestCode) {
    ...
    void replaceFragmentInternal(FragmentManager fm, @IdRes int containerId, @NonNull Fragment fragment,
